...
<Steps>
  ...
  <Step title="Set Read and Write permissions">
    Inside your App, go to **Settings** → **User authentication settings**. Under **App permissions**, select **Read and Write**. Save the settings.
